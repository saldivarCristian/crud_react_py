...
class Estadios {
    ...
    public static function listar(pdo $db, $verComlumnas=[]): array
    {
        ...
        $sql = "SELECT $columna FROM ".DB_CON.".prode_estadios";
        $stmt = $db->query($sql);
    ...
    public static function getDataByNombre($db, $id)
    {
        $sqlCliente = "SELECT
                   *
                FROM ".DB_CON.".prode_estadios WHERE id_estadio = '$id'";
    ...
    public static function getDataByCuil($db, $nombre_club)
    {
        $sql = "SELECT
                   *
                FROM ".DB_CON.".prode_estadios WHERE id_estadio = '$nombre_club'";
        $stmt = $db->query($sql);
        $data = $stmt->fetch(PDO::FETCH_OBJ);
        return $data;
    }
    ...
    public function insertar($db,$obj = [])
    {
        ...
        $sql = "
            INSERT INTO ".DB_CON.".prode_estadios (
                $columnaAInsertar
            )
            VALUES (
                $variableAInsertar   
    ...
    public function actualizar($db,$obj = [],$id_update)
    {
        ...
        $sql = "
            update ".DB_CON.".prode_estadios set
                $columnaActualizar
    ...
    {        
        $sql = "
            DELETE FROM ".DB_CON.".prode_estadios where id_estadio = $id_update
        ";
        $stmt = $db->prepare($sql);
        $stmt->execute();
        $id = $db->lastInsertId();
    ...
    public static function getDataById(pdo $db, $id_estadio, $verComlumnas=[]): object
    {
        ...
        $sql = "SELECT $columna FROM ".DB_CON.".prode_estadios WHERE id_estadio = $id_estadio";
        $stmt = $db->query($sql);
        $data = $stmt->fetch(PDO::FETCH_OBJ);
        return $data;
    }
