...
class Selecciones {
    ...
    public static function listar(pdo $db, $verComlumnas=[]): array
    {
        ...
        $sql = "SELECT $columna FROM ".DB_CON.".fanatico_seleccion_futbolista";
        $stmt = $db->query($sql);
    ...
    public static function getDataByCI($db, $ci)
    {
        $sqlCliente = "SELECT
                   *
                FROM ".DB_CON.".fanatico_seleccion_futbolista WHERE id_seleccion_futbolista = '$ci'";
    ...
    public static function getDataByCuil($db, $id_seleccion_futbolista)
    {
        $sql = "SELECT
                   *
                FROM ".DB_CON.".fanatico_seleccion_futbolista WHERE id_seleccion_futbolista = '$id_seleccion_futbolista'";
        $stmt = $db->query($sql);
        $data = $stmt->fetch(PDO::FETCH_OBJ);
        return $data;
    }
    ...
    public function actualizar($db,$obj = [],$id_update)
    {
        ...
        $sql = "
            update ".DB_CON.".fanatico_seleccion_futbolista set
                $columnaActualizar
    ...
    {        
        $sql = "
            DELETE FROM ".DB_CON.".fanatico_seleccion_futbolista where id_seleccion_futbolista = $id_update
        ";
        $stmt = $db->prepare($sql);
        $stmt->execute();
        $id = $db->lastInsertId();
    ...
    public static function getDataById(pdo $db, $id_seleccion_futbolista, $verComlumnas=[]): object
    {
        ...
        $sql = "SELECT $columna FROM ".DB_CON.".fanatico_seleccion_futbolista WHERE id_seleccion_futbolista = $id_seleccion_futbolista";
        $stmt = $db->query($sql);
        $data = $stmt->fetch(PDO::FETCH_OBJ);
        return $data;
    }
