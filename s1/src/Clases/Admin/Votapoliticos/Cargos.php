...
class Cargos {
    ...
    public static function listar(pdo $db, $verComlumnas=[]): array
    {
        ...
        $sql = "SELECT $columna FROM ".DB_CON.".votapoliticos_cargos";
        $stmt = $db->query($sql);
     ...
     *
     * @param [type] $db conexion de base de datos
     * @param [type] $id_cargo filtar partidos por id_partido
     * @return void
     */
    public static function getDataByNombre($db, $id)
    {
        $sqlCliente = "SELECT
                   *
                FROM ".DB_CON.".votapoliticos_cargos WHERE id_cargo = '$id'";
    ...
    public static function getDataByCuil($db, $nombre_club)
    {
        $sql = "SELECT
                   *
                FROM ".DB_CON.".votapoliticos_cargos WHERE id_cargo = '$nombre_club'";
        $stmt = $db->query($sql);
        $data = $stmt->fetch(PDO::FETCH_OBJ);
        return $data;
    }
    ...
    public function insertar($db,$obj = [])
    {
        ...
        $sql = "
            INSERT INTO ".DB_CON.".votapoliticos_cargos (
                $columnaAInsertar
            )
            VALUES (
                $variableAInsertar   
    ...
    public function actualizar($db,$obj = [],$id_update)
    {
        ...
        $sql = "
            update ".DB_CON.".votapoliticos_cargos set
                $columnaActualizar
           where id_cargo = $id_update
        ";
    ...
    {        
        $sql = "
            DELETE FROM ".DB_CON.".votapoliticos_cargos where id_cargo = $id_update
        ";
        $stmt = $db->prepare($sql);
        $stmt->execute();
        $id = $db->lastInsertId();
    ...
    public static function getDataById(pdo $db, $id_partido, $verComlumnas=[]): object
    {
        ...
        $sql = "SELECT $columna FROM ".DB_CON.".votapoliticos_cargos WHERE id_cargo = $id_partido";
        $stmt = $db->query($sql);
        $data = $stmt->fetch(PDO::FETCH_OBJ);
        return $data;
    }
