...
use \Clases\Admin\Prode\Politicos;

$app->group('/admin/prode/politico', function(\Slim\App $app) {
    //Listar
    ...
    $app->get('/listSelect', function(Request $request, Response $response, array $args){
        try{
            ...
            $listMovimiento = \Clases\Admin\Prode\Movimientos::listar($db);
        ...
        try{
            ...
            if (!empty($_FILES['data'])) {
                ...
                if( isset( $responseImage['error'] ) ){
                    ...
                    unlink(__DIR__."/../../../../public/img/Prode/lg/politicos/".$parametros['file_hidden']);
                    unlink(__DIR__."/../../../../public/img/Prode/sm/politicos/".$parametros['file_hidden']);
                    unlink(__DIR__."/../../../../public/img/Prode/md/politicos/".$parametros['file_hidden']);
