...
$app->group('/admin/desafios/clubes', function(\Slim\App $app) {
    //Listar
        ...
        try{
            ...
            if (!empty($_FILES['data'])) {
                ...
                if( isset( $responseImage['error'] ) ){
                    ...
                    unlink(__DIR__."/../../../../public/img/desafios/lg/clubes/".$parametros['file_hidden']);
                    unlink(__DIR__."/../../../../public/img/desafios/sm/clubes/".$parametros['file_hidden']);
                    unlink(__DIR__."/../../../../public/img/desafios/md/clubes/".$parametros['file_hidden']);
