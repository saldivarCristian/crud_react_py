...
//acceso al sistema por app
    $app->post('/cliente/user/st/login3', function(Request $request, Response $response){
...
//Add usuario
//Add usuario
$app->post('/cliente/user/st/addUsuario3', function(Request $request, Response $response){
...
//Actualizar datos personales
    $app->post('/cliente/user/editUsuario3', function(Request $request, Response $response){
...
//RECUPERAR CONTRASENA
    $app->post('/cliente/user/st/recuperar3', function(Request $request, Response $response){
        try
        {
            $db = $this->db;
...
//Cambiar Contrasena
    $app->post('/cliente/user/cambiarContrasena3', function(Request $request, Response $response){
