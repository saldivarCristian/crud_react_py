...
use Api\DataTables;
use Clases\Admin\Desafios\Clientes;

// Routes

//acceso al sistema por app
    $app->post('/cliente/desafio/st/login', function(Request $request, Response $response){
        ...
        try{
            ...
            if ( isset($datos->pass_cliente) ) 
            {
                ...
                {                           
                    ...
                    $nickname_cliente =  $datos->nickname_cliente != null ? $datos->nickname_cliente : "";
                    $id_club_futbol = -1;
...
//Add usuario
    $app->post('/cliente/desafio/st/addUsuario', function(Request $request, Response $response){
...
//Actualizar datos personales
    $app->post('/cliente/desafio/editUsuario', function(Request $request, Response $response){
...
//RECUPERAR CONTRASENA
    $app->post('/cliente/desafio/st/recuperar', function(Request $request, Response $response){
        try
        {
            $db = $this->db;
...
//Cambiar Contrasena
    $app->post('/cliente/desafio/cambiarContrasena', function(Request $request, Response $response){
